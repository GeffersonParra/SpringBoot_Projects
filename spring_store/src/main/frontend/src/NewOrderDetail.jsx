...
const NewOrderDetailForm = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        const response = await axios.post('http://localhost:8080/api/orderdetails', orderData, {
            headers: {
    ...
    return (
        <div className='mt-5 col-7 mx-auto h-auto rounded-4' style={FormStyle}>
            <h1 className="text-center mt-3">Adjuntar un nuevo producto</h1>
