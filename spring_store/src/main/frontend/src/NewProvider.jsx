...
const NewProviderForm = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        const providerData = {
            ...
            const response = await axios.post('http://localhost:8080/api/providers', providerData, {
                headers: {
    ...
    return (
        <div className='mt-5 col-7 mx-auto h-auto rounded-4' style={FormStyle}>
            <h1 className="text-center mt-3">Crear un nuevo proveedor</h1>
            <form onSubmit={handleSubmit} className="mt-4 d-flex flex-column">
                ...
                <button type="submit" className="btn btn-new mx-auto mt-5 mb-5">Crear Proveedor</button>
            </form>
        </div>
    )
}
